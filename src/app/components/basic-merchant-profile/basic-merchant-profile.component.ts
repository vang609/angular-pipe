...
export class BasicMerchantProfileComponent implements OnInit, OnDestroy, AfterContentChecked {
  ...
  maskKeyedIn(e: any, type: string) {
    if ((e.keyCode > 47 && e.keyCode < 58) || e.key === 'Backspace' || (e.keyCode > 95 && e.keyCode < 106)) {
    ...
    if (e.target.value.length < 12) {
      if ((e.keyCode > 47 && e.keyCode < 58) || e.key === 'Backspace' || (e.keyCode > 95 && e.keyCode < 106)) {
        ...
        if (e.key === 'Backspace') {
          ...
          if (type === 'ssn') {
            this.ssnVal.splice(inputValLen, 1);
            if (this.ssnVal.length === 0) {
              numVal = '';
            }
          }
          if (type === 'tin') {
            this.tinVal.splice(inputValLen, 1);
            if (this.tinVal.length === 0) {
              numVal = '';
            }
          }
        }
