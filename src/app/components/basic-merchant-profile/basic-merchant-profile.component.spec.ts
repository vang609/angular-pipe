...
describe('BasicMerchantProfileComponent', () => {
  ...
  it('call ssnKeyedIn function', () => {
    component.ssnKeyedIn({ which: 114, keyCode: 114 });
    expect(component.ssnKeyedIn).toBeTruthy();
  });

  it('call tinKeyedIn function', () => {
    component.tinKeyedIn({ which: 114, keyCode: 114 });
    expect(component.tinKeyedIn).toBeTruthy();
  });
