...
describe('BasicMerchantProfileComponent', () => {
  ...
  it('call setFormValues function', () => {
    component.setFormValues(data.merchantProfile);
    expect(component.setFormValues).toBeTruthy();
  });

  it('call setFormValues function is customers is false', () => {
    component.setFormValues([data.merchantProfileElse]);
    expect(component.setFormValues).toBeTruthy();
  });
  ...
  it('call fetchMerchantDetails Function', () => {
    component.fetchMerchantDetails('Test123');
    expect(component.fetchMerchantDetails).toBeTruthy();
  });
  ...
  it('call maskKeyUp function if EIN value is of length 9', () => {
    component.einVal = ['1', '1', '1', '1', '1', '1', '2', '3', '4'];
    const e = {
      target: {
        value: 'XXX-XX-1234'
      },
  ...
  it('should call fetchBasicMerchantDetails function', () => {
    component.fetchBasicMerchantDetails('SSN', '123457689', 'individual');
    expect(component.fetchBasicMerchantDetails).toBeTruthy();
  });

  it('call getState function', () => {
    component.getState();
    expect(component.getState).toBeTruthy();
  });

  it('call closeWarning function', () => {
    component.closeWarning();
    expect(component.closeWarning).toBeTruthy();
  });
